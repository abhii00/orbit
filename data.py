...
microSolarSystem = [
    ...
    CelestialObject(0.330e24, 2438e3, (231, 232, 236),
                    np.array([400, 400, 0]) * constants.units.L + np.array([46.0e9, 0, 0]), np.array([0, 47.4e3, 0])), #mercury
...
microExplorer = Explorer(1000, constants.consts.R_s*100, (255, 0, 0), 
                        np.array([400, 400, 0])  * constants.units.L - np.array([778.5e9, 0, 0]), np.array([0, 100000, 0]), np.array([0, 0, 0]))